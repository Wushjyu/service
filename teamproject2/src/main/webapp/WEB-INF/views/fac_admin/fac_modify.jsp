              ...
              <div id="fac_inform_input">
                <div id="fac_inform_input1">
                  <form action="fac_modify" method="post" enctype="multipart/form-data">
     			    ...
     			    <input type="hidden" name="old_fails1" value="${fac_admin_Vo.finfo_pic1}">
     			    <input type="hidden" name="old_fails2" value="${fac_admin_Vo.finfo_pic2}">
     			    <input type="hidden" name="old_fails3" value="${fac_admin_Vo.finfo_pic3}">
     			    <input type="hidden" name="old_fails4" value="${fac_admin_Vo.finfo_pic4}">
     			    <input type="hidden" name="old_fails5" value="${fac_admin_Vo.finfo_pic5}">
                    <div class="form-group" id="fac_input">
                      ...
                      <select class="select2-single form-control" name="finfo_sport" id="select2Single" value="${fac_admin_Vo.finfo_sport}">
                        ...
                        <option value="soccer"${fac_admin_Vo.finfo_sport.contains("soccer")?"selected":""}>soccer</option>
                        <option value="baseball"${fac_admin_Vo.finfo_sport.contains("baseball")?"selected":""}>baseball</option>
                        <option value="tennis"${fac_admin_Vo.finfo_sport.contains("tennis")?"selected":""}>tennis</option>
                        <option value="badminton"${fac_admin_Vo.finfo_sport.contains("badminton")?"selected":""}>badminton</option>
                        <option value="futsal"${fac_admin_Vo.finfo_sport.contains("futsal")?"selected":""}>futsal</option>
                      </select>
