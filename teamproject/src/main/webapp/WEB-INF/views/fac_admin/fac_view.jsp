                  ...
                  <form>
                    <div class="form-group" id="fac_input">
                      ...
                      <div class="custom-file">
                        <img class="img" src="/upload/${fac_admin_Vo.finfo_pic1}"><br>
	                    <strong>다운로드|</strong><br><a href="/upload/${fac_admin_Vo.finfo_pic1}">${fac_admin_Vo.finfo_pic1}</a>
                      </div>
                      <div class="custom-file">
                        <img class="img" src="/upload/${fac_admin_Vo.finfo_pic2}"><br>
                        <strong>다운로드|</strong><br><a href="/upload/${fac_admin_Vo.finfo_pic2}">${fac_admin_Vo.finfo_pic2}</a>
                      </div>
                      <div class="custom-file">
                        <img class="img" src="/upload/${fac_admin_Vo.finfo_pic3}"><br>
                      	<strong>다운로드|</strong><br><a href="/upload/${fac_admin_Vo.finfo_pic3}">${fac_admin_Vo.finfo_pic3}</a>
                      </div>
                      <div class="custom-file">
                        <img class="img" src="/upload/${fac_admin_Vo.finfo_pic4}"><br>
                        <strong>다운로드|</strong><br><a href="/upload/${fac_admin_Vo.finfo_pic4}">${fac_admin_Vo.finfo_pic4}</a>
                      </div>
                      <div class="custom-file">
                        <img class="img" src="/upload/${fac_admin_Vo.finfo_pic5}"><br>
                        <strong>다운로드|</strong><br><a href="/upload/${fac_admin_Vo.finfo_pic5}">${fac_admin_Vo.finfo_pic5}</a>
                      </div>
                    ...
                    <a href="fac_selectView?finfo_no=${fac_admin_Vo.finfo_no}" class="btn btn-primary" id="fac_save">시설 예약</a>
